...
if __name__ == "__main__":
    if len(sys.argv) != 5:
        ...
        # search parameters
        terror_general_keys = ["#jihadist", "#Jihadist", "#islam", "#Islam", "#islamist", "#Islamist", "terror", "#terror", "terrorist", "#terrorist", "#terrorattacks", "#attack", "attack", "stabbing", "#stabbing", "van attack", "knife attack"] 
        query = " OR ".join(terror_general_keys)
        search_params = {
            "q":query,
            "result_type":'recent',
            "count":100
