...
if __name__ == "__main__":
    if not len(sys.argv) in [4,5]:
        ...
        # search parameters
        key_words = ["#finabudapest2017","#FINABudapest2017","#FinaBudapest2017","#finabudapest","#FINABudapest"]
        key_words += ["#roadtobudapest","#RoadToBudapest"]
        key_words += ["#dunaarena","#DunaArena"]
        key_words += ["#fina","#FINA","#finaworlds","#FINAWorlds","#FinaWorlds"]
        key_words += ["@finabp2017"]
